  ...
  return (
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        <div
          className="relative w-full h-screen flex items-center justify-center text-center bg-contain bg-no-repeat  bg-top"
          style={{
        ...
        >
          ...
          <div className="relative z-10 text-gray-800 px-4">
            <h1 className="text-6xl font-bold mb-6 tracking-tight">
              GreenBytes{" "}
              <span className="text-green-800">Waste Management</span>
            </h1>
            <p className="text-xl max-w-2xl mx-auto leading-relaxed mb-8">
              Tech Trash? We’ve Got You Covered! – Seamless e-waste pickup and
              recycling.
            </p>
          </div>
        </div>
        ...
        {!loggedIn ? (
          ...
          <>
            ...
            <Link href="/Navigation">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white text-lg py-6 px-10 rounded-full font-medium transition-all duration-300 ease-in-out transform hover:scale-105 mt-4">
                Open Navigation
